...
import { createValidationErrorResponse } from './response-extensions';
  ...
  return (req: Request, res: Response, next: NextFunction): void => {
    ...
    if (schema.params) {
      ...
      if (error) {
        ...
        req.validatedData.params = value;
        req.params = value;
      }
    }
    ...
    if (schema.headers) {
      ...
      if (error) {
        ...
        // Don't replace all headers, just merge validated ones
