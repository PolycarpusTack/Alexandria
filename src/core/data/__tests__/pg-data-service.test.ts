...
describe('PostgresDataService', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should throw error if already initialized', async () => {
      ...
      await expect(dataService.initialize()).rejects.toThrow('Data service is already initialized');
    });
  });
  ...
  describe('Connection Management', () => {
    ...
    it('should handle connection timeout', async () => {
      ...
      await expect((dataService as any).getClient()).rejects.toThrow(DatabaseError);
  ...
  describe('CRUD Operations', () => {
    ...
    describe('create', () => {
      ...
      it('should validate entity data', async () => {
        await expect(dataService.create('test_table', null as any)).rejects.toThrow(
          ValidationError
        );

        await expect(dataService.create('test_table', {} as any)).rejects.toThrow(ValidationError);
      });
      ...
      it('should handle database constraints', async () => {
        ...
        await expect(dataService.create('test_table', { name: 'Test' })).rejects.toThrow(
          DatabaseError
        );
      });
      ...
      it('should prevent SQL injection in table name', async () => {
        await expect(
          dataService.create('test_table; DROP TABLE users; --', { name: 'Test' })
    ...
    describe('findById', () => {
      it('should find entity by ID', async () => {
        ...
        expect(result).toEqual(mockResult.rows[0]);
        expect(mockClient.query).toHaveBeenCalledWith('SELECT * FROM test_table WHERE id = $1', [
          '123'
        ]);
      });
      ...
      it('should validate ID parameter', async () => {
        await expect(dataService.findById('test_table', null as any)).rejects.toThrow(
          ValidationError
        );

        await expect(dataService.findById('test_table', '')).rejects.toThrow(ValidationError);
      });
    });
    ...
    describe('update', () => {
      ...
      it('should validate update data', async () => {
        await expect(dataService.update('test_table', '123', null as any)).rejects.toThrow(
          ValidationError
        );

        await expect(dataService.update('test_table', '123', {})).rejects.toThrow(ValidationError);
      });
    ...
    describe('delete', () => {
      it('should delete entity successfully', async () => {
        ...
        expect(mockClient.query).toHaveBeenCalledWith('DELETE FROM test_table WHERE id = $1', [
          '123'
        ]);
      });
      ...
      it('should validate ID parameter', async () => {
        await expect(dataService.delete('test_table', null as any)).rejects.toThrow(
          ValidationError
        );
      });
    });
    ...
    describe('query', () => {
      ...
      it('should prevent dangerous queries', async () => {
        ...
        for (const query of dangerousQueries) {
          await expect(dataService.query(query)).rejects.toThrow(ValidationError);
        }
      });
      ...
      it('should handle query timeout', async () => {
        ...
        await expect(dataService.query('SELECT * FROM large_table')).rejects.toThrow(DatabaseError);
      });
    });
  ...
  describe('Transaction Management', () => {
    ...
    describe('transaction', () => {
      ...
      it('should rollback on error', async () => {
        ...
        await expect(
          dataService.transaction(async (client) => {
  ...
  describe('Security and Validation', () => {
    ...
    describe('safeColumnName', () => {
      ...
      it('should reject unsafe column names', () => {
        ...
        unsafeNames.forEach((name) => {
          expect(() => (dataService as any).safeColumnName(name)).toThrow(ValidationError);
        });
      });
    });
    ...
    describe('safeTableName', () => {
      ...
      it('should reject unsafe table names', () => {
        ...
        unsafeNames.forEach((name) => {
          expect(() => (dataService as any).safeTableName(name)).toThrow(ValidationError);
        });
      });
    });
    ...
    describe('Query Performance', () => {
      ...
      it('should handle concurrent operations efficiently', async () => {
        ...
        const operations = Array(10)
          .fill(null)
          .map((_, i) => dataService.findById('test_table', `id-${i}`));
  ...
  describe('Error Handling', () => {
    ...
    it('should handle connection errors gracefully', async () => {
      ...
      await expect(dataService.findById('test_table', '123')).rejects.toThrow(DatabaseError);
    ...
    it('should handle constraint violations', async () => {
      ...
      await expect(dataService.create('users', { email: 'test@test.com' })).rejects.toThrow(
        DatabaseError
      );
    });
    ...
    it('should handle foreign key violations', async () => {
      ...
      await expect(dataService.create('posts', { user_id: 'invalid' })).rejects.toThrow(
        DatabaseError
      );
    });
