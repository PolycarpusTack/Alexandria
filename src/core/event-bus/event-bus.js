...
exports.EventBus = exports.EventBusImpl = void 0;
const uuid_1 = require("uuid");
/**
 * EventSubscription internal class to track subscriptions
 */
class EventSubscription {
    constructor(topic, handler, options = {}, isPattern = false) {
        this.eventCount = 0;
        this.id = (0, uuid_1.v4)();
        this.topic = topic;
...
class EventBusImpl {
    constructor(logger) {
        ...
        this.MAX_SUBSCRIPTIONS = 10000; // Maximum number of subscriptions
        this.MAX_SUBSCRIPTIONS_PER_TOPIC = 1000; // Maximum per topic
        this.topicSubscriptionCounts = new Map();
        this.logger = logger;
     ...
     */
    subscribePattern(topicPattern, handler, options = {}) {
        if (!topicPattern) {
     ...
     */
    unsubscribe(subscriptionIdOrTopic, handler) {
     ...
     */
    getMatchingSubscriptions(topic, minPriority) {
        const matching = [];
        for (const subscription of this.subscriptions.values()) {
            if (subscription.matchesTopic(topic) &&
