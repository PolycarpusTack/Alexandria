...
interface StorageBackend {
  ...
  consumeTokens(key: string, tokens: number, refillRate: number, capacity: number): Promise<RateLimitResult>;
  getSlidingWindow(key: string): Promise<any>;
  addToSlidingWindow(key: string, timestamp: bigint, weight: number, windowSize: bigint): Promise<void>;
...
export class SecurityMiddleware {
  ...
  applyAll(app: any) {
    ...
    this.context.services.logger?.info('Security middleware applied with Aegis Enterprise Rate Limiter');
  }
