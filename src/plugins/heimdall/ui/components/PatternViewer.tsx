          ...
          {filteredPatterns.length === 0 ? (
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
              {filteredPatterns.map((pattern) => (
                <Card
                  key={pattern.id}
                  className={`border-l-4 ${getSeverityColor(pattern.severity)}`}
                >
                      ...
                      <div>
                        ...
                        <div className='space-y-1'>
                          {pattern.pattern.examples.slice(0, 2).map((example, idx) => (
                            <div
                              key={idx}
                              className='bg-muted p-2 rounded text-xs font-mono truncate'
                            >
                              {example}
                            </div>
                          ))}
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                ...
                <div>
                  ...
                  <Select
                    value={analysisDepth}
                    onValueChange={(value: any) => setAnalysisDepth(value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
