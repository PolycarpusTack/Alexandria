...
import { Dashboard, LogQueryResult } from '../../src/interfaces';
...
export const VisualizationGrid: React.FC<VisualizationGridProps> = ({ dashboard, service }) => {
    ...
    return (
      <div className='bg-gray-50 border border-gray-300 rounded p-8 text-center'>
        ...
        <p className='text-gray-600 mt-2'>
          This dashboard doesn't have any widgets yet. Add some widgets to start visualizing your
          logs.
        </p>
      </div>
    );
  ...
  const renderWidget = (widget: any) => {
    ...
    switch (widget.type) {
      ...
      case 'metrics':
        return <MetricsCard title={widget.title} data={widgetData} metrics={widget.metrics} />;

      case 'alerts':
        return <AlertPanel title={widget.title} alerts={widget.alerts || []} service={service} />;
