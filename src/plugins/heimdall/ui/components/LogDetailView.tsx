 ...
 */
export const LogDetailView: React.FC<LogDetailViewProps> = ({ service, logId, sourceId }) => {
    ...
    <div className='h-full flex flex-col'>
      <div className='border-b pb-4 mb-4'>
        <div className='flex items-center mb-2'>
          ...
          <span className='ml-2 text-gray-500'>{log.timestamp.toLocaleString()}</span>
        </div>
        ...
        <div className='flex mt-2 text-sm text-gray-500'>
          ...
          {log.serviceName && <span className='mr-4'>Service: {log.serviceName}</span>}
