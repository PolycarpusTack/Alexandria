      ...
      {resourceUsage && resourceLimits && (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>{resourceUsage.total.memoryMB.toFixed(0)} MB</div>
              <Progress
                value={calculateUsagePercentage(
                  resourceUsage.total.memoryMB,
              ...
              <p className='text-xs text-muted-foreground mt-1'>
                ...
                % of {resourceLimits.maxMemoryMB} MB
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress
                value={calculateUsagePercentage(
                  resourceUsage.total.connections,
                  resourceLimits.maxConnections
                )}
                className='mt-2'
              />
              <p className='text-xs text-muted-foreground mt-1'>
                ...
                % of {resourceLimits.maxConnections}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress
                value={calculateUsagePercentage(
                  resourceUsage.total.activeQueries,
                  resourceLimits.maxConcurrentQueries
                )}
                className='mt-2'
              />
              <p className='text-xs text-muted-foreground mt-1'>
                ...
                % of {resourceLimits.maxConcurrentQueries}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className='text-xs text-muted-foreground mt-1'>System CPU utilization</p>
            </CardContent>
          </Card>
        </div>
      )}
            ...
            {connectionPools.map((pool) => (
              <div key={pool.poolName} className='border rounded p-4'>
                <div className='flex items-center justify-between mb-2'>
                  ...
                  <Badge variant='outline'>{pool.totalConnections} total</Badge>
                </div>
              ...
              <div key={breaker.serviceName} className='border rounded p-4'>
                <div className='flex items-center justify-between mb-2'>
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    <Badge className={getStatusColor(breaker.state)}>{breaker.state}</Badge>
                  </div>
                </div>
                <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                  <div>
                  ...
                  <div>
                    ...
                    <span className='ml-1 font-medium'>
                      {breaker.totalCalls > 0
                        ? ((breaker.successes / breaker.totalCalls) * 100).toFixed(1)
                        : 0}
                      %
                    </span>
                  </div>
