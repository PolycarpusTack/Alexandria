...
import { LogQuery, LogQueryResult, LogLevel, LogSourceType } from '../../src/interfaces';
              ...
              {logLevels.map(level => (
                <label key={level} className="flex items-center space-x-2">
                  ...
                  <span className={`text-sm px-2 py-1 rounded ${
                    level === LogLevel.ERROR ? 'bg-red-100 text-red-800' :
                    level === LogLevel.WARN ? 'bg-yellow-100 text-yellow-800' :
                    level === LogLevel.INFO ? 'bg-blue-100 text-blue-800' :
                    level === LogLevel.DEBUG ? 'bg-gray-100 text-gray-800' :
