...
export interface ParsedCrashData {
  ...
  metadata: Record<string, any>; // Any additional structured data
}
...
export interface SystemInfo {
  ...
  memoryUsage?: string;
  cpuUsage?: string;
  otherHardwareInfo?: Record<string, any>;
  otherSoftwareInfo?: Record<string, any>;
}
...
export interface ICrashAnalyzerService {
  analyzeLog(logId: string, content: string, metadata: any): Promise<CrashAnalysisResult>;
...
export interface ILogParser {
  parse(content: string, metadata?: any): Promise<ParsedCrashData>;
...
export interface ILlmService {
   ...
   */
  analyzeCodeSnippet?(code: string, language: string, customModel?: string): Promise<any>;
...
export interface CollectionDataService {
  ...
  upsert(collectionName: string, id: string, data: any): Promise<any>;
