...
class MockCrashRepository implements ICrashRepository {
  ...
  async saveCrashLog(crashLog: CrashLog): Promise<CrashLog> {
  ...
  async saveAnalysisResult(result: CrashAnalysisResult): Promise<CrashAnalysisResult> {
