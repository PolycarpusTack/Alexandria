...
export class InputValidator {
   ...
   */
  static validateLogAnalysis(params: { logId: string; content: string; metadata: any }): void {
    const errors: Array<{ field: string; message: string; value?: any }> = [];
    ...
    } else if (params.content.length > 10 * 1024 * 1024) {
      // 10MB limit
  ...
  static validateCodeSnippet(params: {
    ...
    } else if (params.content.length > 1024 * 1024) {
      // 1MB limit
