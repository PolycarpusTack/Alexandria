...
export const CodeSnippetDetail: React.FC<CodeSnippetDetailProps> = ({ crashAnalyzerService }) => {
  ...
  const handleReanalyzeClick = async () => {
    ...
    try {
      ...
      await crashAnalyzerService.analyzeCodeSnippet(snippet.id, snippet.sessionId);
    ...
    <div className='p-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
        <Card>
          ...
          <p className='text-sm'>
            <span className='font-medium'>Uploaded:</span> {formatDate(snippet.createdAt)}
          </p>
          <p className='text-sm'>
        ...
        <Card>
          ...
          <p className='text-sm'>
            <span className='font-medium'>Session ID:</span> {snippet.sessionId}
          </p>
          <p className='text-sm'>
          ...
          {analysis ? (
                            ...
                            <div className='bg-white rounded border p-2 space-y-2'>
                              {issue.supportingEvidence.map((evidence: any, i: number) => (
                                <div key={i} className='text-sm'>
                                  ...
                                  <div className='text-gray-600 mt-1'>{evidence.description}</div>
                                </div>
                              ))}
                            </div>
                          </div>
            ...
            <Card className='mt-4 bg-gray-50'>
              <div className='text-center py-8'>
                <p className='text-gray-500 mb-4'>This code snippet has not been analyzed yet.</p>
