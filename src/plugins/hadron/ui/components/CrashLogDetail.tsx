...
export const CrashLogDetail: React.FC<CrashLogDetailProps> = ({ crashAnalyzerService }) => {
  ...
  const handleReanalyzeClick = async () => {
    ...
    try {
      ...
      await crashAnalyzerService.analyzeLog(crashLog.id, crashLog.content, crashLog.metadata);
    ...
    try {
      ...
      if (exportFormat === 'json') {
        ...
        content =
          ...
          (crashLog.analysis?.potentialRootCauses
            ?.map(
              (cause, i) =>
    ...
    <div className='p-4'>
      ...
      <div className='flex items-center mb-6'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex gap-2'>
            ...
            <Button variant='outline' size='small' onClick={handleExport} disabled={loading}>
              Export
            </Button>
          </div>
        </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
        ...
        <Card>
          ...
          <p className='text-sm'>
            <span className='font-medium'>Platform:</span> {crashLog.metadata.platform || 'Unknown'}
          </p>
          <p className='text-sm'>
          ...
          <p className='text-sm'>
            <span className='font-medium'>Device:</span> {crashLog.metadata.device || 'Unknown'}
          </p>
        </Card>
          ...
          {crashLog.analysis ? (
            ...
            <Card className='mt-4 bg-gray-50'>
              <div className='text-center py-8'>
                <p className='text-gray-500 mb-4'>This crash log has not been analyzed yet.</p>
