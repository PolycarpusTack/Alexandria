      ...
      >
        ...
        <div className='relative z-10 flex flex-col justify-center p-12 lg:p-16'>
          <div className='mb-12'>
            ...
            <p className={cn('text-xl mb-12', isDark ? 'text-gray-300' : 'text-gray-700')}>
          ...
          >
            <div className='flex items-center gap-8 text-sm'>
              <div className='flex items-center gap-2'>
                ...
                <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>99.9% Uptime</span>
              </div>
              <div className='flex items-center gap-2'>
                <Shield className={cn('w-4 h-4', isDark ? 'text-blue-400' : 'text-blue-600')} />
        ...
        <div className='w-full max-w-md px-8'>
          ...
          <form id='login-form' onSubmit={handleSubmit} className='space-y-5'>
            ...
            <div className='space-y-2'>
              <label
                className={cn('text-sm font-medium', isDark ? 'text-gray-200' : 'text-gray-700')}
              >
                Username
              </label>
            ...
            <div className='relative'>
              <div className='absolute inset-0 flex items-center'>
                <div
                  className={cn('w-full border-t', isDark ? 'border-white/10' : 'border-gray-200')}
                />
              </div>
            ...
            <div className='grid grid-cols-2 gap-3'>
              <Button
                type='button'
                variant='outline'
                className={cn('h-11', isDark ? 'border-white/10 hover:bg-white/5' : '')}
              >
            ...
            <p
              className={cn('text-xs text-center pt-2', isDark ? 'text-gray-500' : 'text-gray-500')}
            >
              Press{' '}
              <kbd
                className={cn(
