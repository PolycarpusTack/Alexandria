    ...
    <div className={cn('app-shell', className)}>
        ...
        <header className='alexandria-header'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <div className='user-menu'>
              ...
              <div className='avatar'>{auth?.user?.username?.charAt(0).toUpperCase() || 'D'}</div>
            ...
            <div className='nav-section'>
              ...
              {getNavigationSections()[1].items.map((item) => (
                ...
                >
                  ...
                  {item.id === 'heimdall' && (
                    <TrendingUp className='nav-icon h-5 w-5 text-purple-500' />
                  )}
                  <span>{item.label}</span>
      ...
      {layoutState.commandPaletteOpen && (
        <div
          ...
          onClick={() => layoutActions.setCommandPaletteOpen(false)}
        >
          <div
            className='fixed top-20 left-1/2 transform -translate-x-1/2 w-full max-w-2xl bg-card border border-border rounded-lg shadow-lg'
