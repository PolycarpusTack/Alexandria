                ...
                {results.map((result) => (
                  ...
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-md bg-primary/10">
                      {result.type === 'plugin' && <i className="fa-solid fa-puzzle-piece text-primary"></i>}
                      {result.type === 'document' && <i className="fa-solid fa-file-alt text-primary"></i>}
                      {result.type === 'model' && <i className="fa-solid fa-robot text-primary"></i>}
                    </div>
